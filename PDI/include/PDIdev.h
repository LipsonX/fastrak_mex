...
//
//  VSS $Header: /PiDevTools11/Inc/PDIdev.h 13    1/09/14 1:05p Suzanne $  
//
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
#ifndef _PDIDEV_H_
...
public:
	...
	BOOL    StartSocketExport  ( LPCTSTR szInterfaceAddress=PDI_EXPORT_SOCK_ADDR,
		                         SHORT nSocketPort=PDI_EXPORT_SOCK_PORT); //Starts raw P&O on addr:port
	BOOL    CancelSocketExport ( VOID );                                  // Cancels raw P&O export on addr:port
